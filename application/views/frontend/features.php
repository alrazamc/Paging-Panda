...
<main class="main-content">
   ...
   <section id="features" class="section">
      <div class="container">
         <header class="section-header">
            ...
            <h2>Smart Features to save your time and money</h2>
            <hr>
         </header>
         ...
         <div class="row gap-y align-items-center">
            <div class="col-md-6 mr-auto">
               ...
               <p>Create, 24/7 posting schedule based on your categories. Using your content and schedule, Paging Panda will auto-fill posts queue for next two weeks. You can also manually schedule certain content for specific date/time. Review the post queue to check what's going to be published on which page and when.</p>
               <p>Paging Panda will cycle through your content in an orderly fashion and will re-publish the content when all items in a category are published so you will never run out of content for your pages</p>
            </div>
            <div class="col-md-5">
               <div class="row">
   ...
   <section id="faq" class="section bg-gray">
      <div class="container">
         <header class="section-header">
            <h2>Complete features walk-through</h2>
