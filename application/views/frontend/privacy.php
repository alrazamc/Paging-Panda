        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content">
              ...
              <p>Paging Panda ("us", "we", or "our") operates the https://pagingpanda.com/ website (the "Service").</p>
              ...
              <h5>Social Accounts and Content</h5>
              <p>
              ...
              <h3>Use of Data</h3>
              <p>Paging Panda uses the collected data for various purposes:</p>
              <ul>
                <li>To provide and maintain the Service</li>
                <li>To send you notifications, newsletters and promotional content via email</li>
              ...
              <p>If you are located outside Pakistan and choose to provide information to us, please note that we may transfer the data, including Personal Data, to Pakistan and process it there.</p>
              <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>
              <p>Paging Panda will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
              <h3>Disclosure of Data</h3>
              <h4>Legal Requirements</h4>
              <p>Paging Panda may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
              <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of Paging Panda</li>
              ...
              <h3>Contact Us</h3>
              <p>If you have any questions about this Privacy Policy, or you want to access/update/delete your data, please contact us:</p>
              <ul>
                <li>By email: <a href="mailto:support@pagingpanda.com" target="_blank" class="text-success">support@pagingpanda.com</a></li>
              </ul>
            </div>
          </div>
        </div>
